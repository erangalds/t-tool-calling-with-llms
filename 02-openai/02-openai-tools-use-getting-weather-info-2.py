...
messages.append(
    {
        "role": "user", 
        "content": "what is the weather going to be like in Glasgow, Scotland over the next x days in fahrenheit"
    }
)
...
# Once again, the model is asking us for clarification because it doesn't have enough information yet. 
# In this case it already knows the location for the forecast, but it needs to know how many days are required in the forecast.
